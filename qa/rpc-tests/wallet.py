...
#   c) node1 mines 32 blocks, so now node 0 has 60001cbet, node 1 has 4250cbet, node2 has none.
#   d) node0 sends 601 cbet to node2, in two transactions (301 cbet, then 300 cbet).
