...
/**
 * ClassicBets RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzcbetseed(const UniValue& params, bool fHelp);
extern UniValue getzcbetseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzcbet(const UniValue& params, bool fHelp);
extern UniValue dzcbetstate(const UniValue& params, bool fHelp);
