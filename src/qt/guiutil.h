...
/** Utility functions used by the ClassicBets Qt UI.
 */
namespace GUIUtil
{
...
// Render ClassicBets addresses in monospace font
...
// Parse "classicbets:" URI into recipient object, return true on successful parsing
