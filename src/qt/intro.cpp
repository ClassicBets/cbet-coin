...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("ClassicBets Core"),
     ...
     * override -datadir in the classicbets.conf file in the default data directory
     * (to be consistent with classicbetsd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
