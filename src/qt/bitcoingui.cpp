                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ClassicBets Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ClassicBets address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and classicbets: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zCBET"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ClassicBets Core"), this);
    aboutAction->setStatusTip(tr("Show information about ClassicBets Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ClassicBets"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ClassicBets addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ClassicBets addresses"));
    ...
    openAction->setStatusTip(tr("Open a ClassicBets: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ClassicBets Core help message to get a list with possible ClassicBets command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ClassicBets Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ClassicBets network", "", count));
}
...
{
    QString strTitle = tr("ClassicBets Core"); // default title
