...
public:
    ...
    QLabel *wallet_customzcbetbackuppath_label;
    QLabel *wallet_customzcbetbackuppath;
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        wallet_customzcbetbackuppath_label = new QLabel(tab_repair);
        wallet_customzcbetbackuppath_label->setObjectName(QStringLiteral("wallet_customzcbetbackuppath_label"));
        wallet_customzcbetbackuppath_label->setVisible(false);

        gridLayout_4->addWidget(wallet_customzcbetbackuppath_label, 4, 0, 1, 1);

        wallet_customzcbetbackuppath = new QLabel(tab_repair);
        wallet_customzcbetbackuppath->setObjectName(QStringLiteral("wallet_customzcbetbackuppath"));
        wallet_customzcbetbackuppath->setCursor(QCursor(Qt::IBeamCursor));
        wallet_customzcbetbackuppath->setTextFormat(Qt::PlainText);
        wallet_customzcbetbackuppath->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);
        wallet_customzcbetbackuppath->setVisible(false);

        gridLayout_4->addWidget(wallet_customzcbetbackuppath, 4, 1, 1, 3);
    ...
    void retranslateUi(QDialog *RPCConsole)
    {
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the ClassicBets debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
        ...
        wallet_customzcbetbackuppath_label->setText(QApplication::translate("RPCConsole", "Custom zCBET Backup Path:", 0));
        wallet_customzcbetbackuppath->setText(QApplication::translate("RPCConsole", "N/A", 0));
