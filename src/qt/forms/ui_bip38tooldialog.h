...
public:
    ...
    void retranslateUi(QDialog *Bip38ToolDialog)
    {
        ...
        infoLabel_ENC->setText(QApplication::translate("Bip38ToolDialog", "Enter a ClassicBets Address that you would like to encrypt using BIP 38. Enter a passphrase in the middle box. Press encrypt to compute the encrypted private key.", 0));
        label_5->setText(QApplication::translate("Bip38ToolDialog", "Address:", 0));
#ifndef QT_NO_TOOLTIP
        addressIn_ENC->setToolTip(QApplication::translate("Bip38ToolDialog", "The ClassicBets address to encrypt", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        encryptKeyButton_ENC->setToolTip(QApplication::translate("Bip38ToolDialog", "Encrypt the private key for this ClassicBets address", 0));
#endif // QT_NO_TOOLTIP
