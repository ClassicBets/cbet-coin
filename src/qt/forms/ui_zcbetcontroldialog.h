/********************************************************************************
** Form generated from reading UI file 'zcbetcontroldialog.ui'
**
...
#ifndef UI_ZCBETCONTROLDIALOG_H
#define UI_ZCBETCONTROLDIALOG_H
...
public:
    ...
    void setupUi(QDialog *ZPivControlDialog)
    {
        ...
        __qtreewidgetitem->setText(3, QStringLiteral("zCBET Version"));
        __qtreewidgetitem->setText(2, QStringLiteral("zCBET ID"));
    ...
    {
        ZPivControlDialog->setWindowTitle(QApplication::translate("ZPivControlDialog", "Select zCBET to Spend", 0));
        labelQuantity->setText(QApplication::translate("ZPivControlDialog", "Quantity", 0));
        labelQuantity_int->setText(QApplication::translate("ZPivControlDialog", "0", 0));
        labelZPiv->setText(QApplication::translate("ZPivControlDialog", "zCBET", 0));
        labelZPiv_int->setText(QApplication::translate("ZPivControlDialog", "0", 0));
        pushButtonAll->setText(QApplication::translate("ZPivControlDialog", "Select/Deselect All", 0));
        QTreeWidgetItem *___qtreewidgetitem = treeWidget->headerItem();
        ___qtreewidgetitem->setText(5, QApplication::translate("ZPivControlDialog", "Is Spendable", 0));
    } // retranslateUi
