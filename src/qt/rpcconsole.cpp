                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzCBETPathCustom = GetArg("-zcbetbackuppath", "");
    ...
    if(!strzCBETPathCustom.empty()) {
        ui->wallet_customzcbetbackuppath->setText(QString::fromStdString(strzCBETPathCustom));
        ui->wallet_customzcbetbackuppath_label->setVisible(true);
        ui->wallet_customzcbetbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzCBETPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the ClassicBets RPC console.") + "<br>" +
