...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("ClassicBets Core classicbets-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  classicbets-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded classicbets transaction") + "\n" +
                               "  classicbets-tx [options] -create [commands]   " + _("Create hex-encoded classicbets transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded classicbets transaction
