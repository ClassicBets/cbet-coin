...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop ClassicBets server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "ClassicBets server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ClassicBets features */
        {"classicbets", "masternode", &masternode, true, true, false},
        {"classicbets", "listmasternodes", &listmasternodes, true, true, false},
        {"classicbets", "getmasternodecount", &getmasternodecount, true, true, false},
        {"classicbets", "masternodeconnect", &masternodeconnect, true, true, false},
        {"classicbets", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"classicbets", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"classicbets", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"classicbets", "masternodecurrent", &masternodecurrent, true, true, false},
        {"classicbets", "masternodedebug", &masternodedebug, true, true, false},
        {"classicbets", "startmasternode", &startmasternode, true, true, false},
        {"classicbets", "createmasternodekey", &createmasternodekey, true, true, false},
        {"classicbets", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"classicbets", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"classicbets", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"classicbets", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"classicbets", "getmasternodescores", &getmasternodescores, true, true, false},
        {"classicbets", "mnbudget", &mnbudget, true, true, false},
        {"classicbets", "preparebudget", &preparebudget, true, true, false},
        {"classicbets", "submitbudget", &submitbudget, true, true, false},
        {"classicbets", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"classicbets", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"classicbets", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"classicbets", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"classicbets", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"classicbets", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"classicbets", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"classicbets", "checkbudgets", &checkbudgets, true, true, false},
        {"classicbets", "mnsync", &mnsync, true, true, false},
        {"classicbets", "spork", &spork, true, true, false},
        {"classicbets", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzcbetseed", &getzcbetseed, false, false, true},
        {"zerocoin", "setzcbetseed", &setzcbetseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzcbet", &searchdzcbet, false, false, true},
        {"zerocoin", "dzcbetstate", &dzcbetstate, false, false, true}
...
{
    return "> classicbets-cli " + methodname + " " + args + "\n";
}
