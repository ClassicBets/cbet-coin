...
#ifndef ClassicBets_ZCBETWALLET_H
#define ClassicBets_ZCBETWALLET_H
...
public:
    CzCBETWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZCBET(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZCBET(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //ClassicBets_ZCBETWALLET_H
