/* src/config/classicbets-config.h.  Generated from classicbets-config.h.in by configure.  */
/* src/config/classicbets-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef CBET_CONFIG_H

#define CBET_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.classicbets.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "ClassicBets Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "ClassicBets Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "classicbets"
