Contributing to ClassicBets Core
============================

The ClassicBets Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ClassicBets Core project, and is not to be
confused with overall ClassicBets Network Protocol consensus changes.

Whether a pull request is merged into ClassicBets Core rests with the project merge
...
Patches that change ClassicBets consensus rules are considerably more involved than
...
Where a patch set proposes to change the ClassicBets consensus, it must have been
...
The project leader is the release manager for each ClassicBets Core release.
