...
### Show progress percent for zcbet reindex operations
...
ClassicBets Daemon & Client (RPC Changes)
--------------
...
This fix was previously included in the `v1.0.0.0` tag, and relayed to affected exchanges/services, which typically use this command for accounting purposes. It is included here for completeness.
...
### Core Features
 ...
 - #609 `6b73598b9` [MoveOnly] Remove zCBET code from main.cpp (presstab)
...
### GUI
 ...
 - #600 `217433561` [GUI] Only enable/disable PrivacyDialog zCBET elements if needed. (presstab)
 - #612 `6dd752cb5` [Qt] Show progress percent for zCBET reindex operations (Fuzzbawls)
...
### Wallet
 ...
 - #603 `779d8d597` Fix spending for v1 zCBET created before block 1050020. (presstab)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/ClassicBets-project-translations/).
