...
In order to support loading of multiple wallets in classicbets-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is classicbets.cpp.
...
Changes to classicbets.cpp
----------------------
classicbets.cpp is the entry point into classicbets-qt, and as such, will require some minor modifications to provide hooks for
