...
Copy the masternode private key and correspondig collateral output transaction that holds the 1K ClassicBets.
...
[From the ClassicBets github repo](https://github.com/ClassicBets-crypto/ClassicBets/blob/master/doc/masternode_conf.md)
...
If you are using a masternode.conf file you no longer need the classicbets.conf file. The exception is if you need custom settings (thanks oblox). 

## Update classicbets.conf on server

If you generated a new masternode private key, you will need to update the remote classicbets.conf files.

Shut down the daemon and then edit the file.

```sudo nano .classicbets/classicbets.conf```

### Edit the masternodeprivkey
If you generated a new masternode private key, you will need to update the masternodeprivkey value in your remote classicbets.conf file.
