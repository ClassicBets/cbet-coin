...
pkgdatadir = $(datadir)/classicbets
pkgincludedir = $(includedir)/classicbets
pkglibdir = $(libdir)/classicbets
pkglibexecdir = $(libexecdir)/classicbets
...
CONFIG_HEADER = $(top_builddir)/src/config/classicbets-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/classicbets-config.h.in \
...
ACLOCAL = ${SHELL} /home/viktor/Plocha/TCBET/ClassicBets_zaloha/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /home/viktor/Plocha/TCBET/ClassicBets_zaloha/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/viktor/Plocha/TCBET/ClassicBets_zaloha/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/viktor/Plocha/TCBET/ClassicBets_zaloha/build-aux/missing automake-1.15
AWK = gawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = classicbets-cli
BITCOIN_DAEMON_NAME = classicbetsd
BITCOIN_GUI_NAME = classicbets-qt
BITCOIN_TX_NAME = classicbets-tx
...
MAINT = 
MAKEINFO = ${SHELL} /home/viktor/Plocha/TCBET/ClassicBets_zaloha/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = classicbets
PACKAGE_BUGREPORT = www.classicbets.com
PACKAGE_NAME = ClassicBets Core
PACKAGE_STRING = ClassicBets Core 1.0.0
PACKAGE_TARNAME = classicbets
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /home/viktor/Plocha/TCBET/ClassicBets_zaloha
abs_srcdir = /home/viktor/Plocha/TCBET/ClassicBets_zaloha
abs_top_builddir = /home/viktor/Plocha/TCBET/ClassicBets_zaloha
abs_top_srcdir = /home/viktor/Plocha/TCBET/ClassicBets_zaloha
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/viktor/Plocha/TCBET/ClassicBets_zaloha/build-aux/install-sh
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_classicbets_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_classicbets_coverage.info test_classicbets.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/ClassicBets-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/classicbets-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/classicbets-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/classicbets-config.h
$(top_srcdir)/src/config/classicbets-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/classicbets-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/ClassicBets-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/ClassicBets-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/ClassicBets-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_classicbets.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_classicbets -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_classicbets_filtered.info: test_classicbets.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_classicbets_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_classicbets_coverage.info: baseline_filtered_combined.info test_classicbets_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_classicbets_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_classicbets_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_classicbets_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_classicbets.coverage/.dirstamp:  test_classicbets_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_classicbets.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf test_classicbets.coverage/ total.coverage/ $(OSX_APP)
