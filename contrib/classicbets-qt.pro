...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/classicbets-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/classicbets-cli.cpp \
           src/classicbets-tx.cpp \
           src/classicbets.cpp \
           src/db.cpp \
           ...
           src/qt/classicbets.cpp \
           src/qt/classicbetsstrings.cpp \
...
RESOURCES += src/qt/classicbets.qrc src/qt/classicbets_locale.qrc

TRANSLATIONS += src/qt/locale/classicbets_bg.ts \
                src/qt/locale/classicbets_de.ts \
                src/qt/locale/classicbets_en.ts \
                src/qt/locale/classicbets_es.ts \
                src/qt/locale/classicbets_fi.ts \
                src/qt/locale/classicbets_fr.ts \
                src/qt/locale/classicbets_it.ts \
                src/qt/locale/classicbets_ja.ts \
                src/qt/locale/classicbets_pl.ts \
                src/qt/locale/classicbets_pt.ts \
                src/qt/locale/classicbets_ru.ts \
                src/qt/locale/classicbets_sk.ts \
                src/qt/locale/classicbets_sv.ts \
                src/qt/locale/classicbets_vi.ts \
                src/qt/locale/classicbets_zh_CN.ts \
                src/qt/locale/classicbets_zh_TW.ts
